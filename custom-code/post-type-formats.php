...
function register_custom_post_type_video()
{
    ...
    $args = array(
        ...
        'supports'          => array('title', 'editor', 'thumbnail', 'excerpt', 'comments', 'author', 'embed'),
        'hierarchical'      => false,
        'show_in_rest'      => true,
        'rest_base'         => 'videos',
...
function register_custom_post_type_short_article()
{
    ...
    $args = array(
        ...
        'show_in_menu'      => true,
        'query_var'         => true,
        'rewrite'           => array('slug' => 'short-article'),
        'capability_type'   => 'post',
        'supports'          => array('title', 'editor', 'thumbnail', 'excerpt', 'comments', 'author', 'embed'),
        'hierarchical'      => false,
        'show_in_rest'      => true,
...
function register_custom_post_type_custom_story()
{
    ...
    $args = array(
        ...
        'show_in_menu'      => true,
        'query_var'         => true,
        'rewrite'           => array('slug' => 'custom-story'),
        'capability_type'   => 'post',
        'supports'          => array('title', 'editor', 'thumbnail', 'excerpt', 'comments', 'author', 'embed'),
        'hierarchical'      => false,
        'show_in_rest'      => true,
