...
<channel>
	...
	<?php if ( strlen( $content ) > 0 ) : ?>
		<content:encoded><![CDATA[<?php echo $content; echo 'This article was originally published on <a href="'.get_permalink().'">Mongabay</a>'; ?>]]></content:encoded>
	<?php else : ?>
		<content:encoded><![CDATA[<?php the_excerpt_rss(); echo 'This article was originally published on <a href="'.get_permalink().'">Mongabay</a>'; ?>]]></content:encoded>
	<?php endif; ?>
