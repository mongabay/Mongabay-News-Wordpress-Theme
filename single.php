            ...
            <?php if (have_posts()): while (have_posts()) : the_post(); ?>
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    ...
                    <div id="single-article-footer">
                        ...
                        <?php if (get_current_blog_id() === 20) { echo '<a href="https://mongabay.org/donate/?utm_source=mongabay.com&utm_medium=bottom-of-news-post&utm_campaign=support-our-journalism-2023" style="display:block;margin-bottom:2rem;"><img src="https://imgs.mongabay.com/wp-content/uploads/sites/20/2022/01/15035219/support-our-journalism.jpg" width="480" height="258"></a>';} ?>
                            <span>
                        ...
                        <a href="amp/?print" style="text-align:center;display:block;width: 45px;color: inherit;text-transform: uppercase;margin: 1em 0;font-size: 0.8em;"><svg style="width:45px;height:35px;" class="icon" fill="#669a00"><use xlink:href="#print"></use></svg>Print</a>
                        </div>
