  ...
  <div class="container ph--40 pv--40 in-column">
    ...
    <div id="section-post-latest" class="container pv--40 gap--20 in-column">
      <div class="container in-row full-width section--headline" style="align-items: center; justify-content: space-between;">
        ...
        <a href="<?php echo home_url(); ?>/series/<?php echo $specials_serie_slug; ?>" class="theme--button primary"><?php _e('All articles', 'mongabay'); ?><span class="icon icon-right"></span></a>
      </div>
      <div class="grid--4 gap--20">
        <?php
        articles_listing(array('post'), 8, 0, true, 'medium', null, null, 'serial', $specials_serie_slug);
        ?>
      </div>
