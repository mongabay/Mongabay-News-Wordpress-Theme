...
<div class="container content gap--40">
	<div class="column--20 latest-news">
		...
		<div class="container in-column gap--16 pv--8">
			<?php articles_listing(array('post', 'custom-story', 'short-article'), 6, 0, false, 'thumbnail-medium', null, null, null); ?>
	...
	<div class="column--60 latest-featured gap--8">
		...
		<?php featured_articles_listing(array('post', 'videos', 'podcasts', 'short-article', 'custom-story'), 5, 0, 'thumbnail-medium', 2, true, null, null); ?>
	</div>
	...
	<div class="section--highlight">
		<div class="container gap--40 in-column">
			...
			<div class="shorts grid--3 gap--40">
				<?php articles_listing_condensed('short-article', 6, 0, false, 'thumbnail-medium', null); ?>
			</div>
		</div>
	</div>
<?php } ?>
