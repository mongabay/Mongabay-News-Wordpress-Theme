(function ($) {
  ...
  $(".load-more-button").on("click", function () {
    ...
    const loadingButton = preloader + ajaxpagination.i18n.loading;
    const initialButton = ajaxpagination.i18n.loadMore + '<span class="icon icon-right"></span>';
    const noResultsButton = ajaxpagination.i18n.noPosts;
