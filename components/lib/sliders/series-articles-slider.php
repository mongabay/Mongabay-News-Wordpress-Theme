...
{
  $args = array('post_type' => $post_type, 'posts_per_page' => 1, 'cache_results' => true);

  if (!get_enabled_features('specials')) {
    $args = array('post_type' => 'post', 'posts_per_page' => 8, 'offset' => 6, 'cache_results' => true);
    $posts_query = new WP_Query($args);

    if ($posts_query->have_posts()) {
      echo '<div class="container grid--4 gap--20">';
            ...
            <div class="article--container full-height">
              <a href="<?php the_permalink(); ?>">
                <div class="featured-image full-height">
                  <div class="img-overlay"></div>
                  <?php the_post_thumbnail('medium', ['class' => 'full-height']); ?>
                  <div class="article--container-headline">
                    <div class="title headline gap--8">
                      <div class="meta">
